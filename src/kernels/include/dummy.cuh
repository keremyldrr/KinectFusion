...
namespace Wrapper
{
	...
	void poseEstimation(VirtualSensor &sensor,Matrix4f &modelToFramePose, CameraParameters cameraParams, cv::cuda::GpuMat surfacePoints, cv::cuda::GpuMat surfaceNormals,int level);
